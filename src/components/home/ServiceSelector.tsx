    ...
    <section className="border-b border-border bg-white px-5 py-12 md:px-8 md:py-16">
      <div className="mx-auto max-w-5xl">
        ...
        <div className="mt-6 grid grid-cols-1 gap-4 md:grid-cols-2">
          ...
          >
            <div className="flex h-12 w-12 items-center justify-center rounded-full bg-[#E7EBE4] text-[#102A22]">
            ...
            <span className="mt-5 inline-flex items-center gap-1 text-[14px] font-semibold text-[#102A22]">
              화환 예상금액 확인하기
